...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke0_mut__hb49c0f8c7c36bc40: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h3870e51a03137068: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h1ed8854034c9aae1: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h987ed7e8f65dc1a7: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h3924be89d96687b6: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h6fcd0208a8532b11: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf3ae89a6bef83f1c: (a: number, b: number, c: number) => void;
